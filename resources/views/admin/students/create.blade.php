        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-0 py-3 px-4 d-flex align-items-center gap-2">
                    ...
                    <h5 class="fw-bold mb-0 text-slate-800">Student Information</h5>
                </div>
                    ...
                    <form action="{{ route('admin.students.store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="first_name" id="first_name" class="form-control @error('first_name') is-invalid @enderror" placeholder="John" value="{{ old('first_name') }}" required>
                                @error('first_name')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="last_name" id="last_name" class="form-control @error('last_name') is-invalid @enderror" placeholder="Doe" value="{{ old('last_name') }}" required>
                                @error('last_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="1234567890" value="{{ old('phone') }}" required>
