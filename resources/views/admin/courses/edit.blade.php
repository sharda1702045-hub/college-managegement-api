...
@section('page_title', 'Edit Course Details')
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-0 py-3 px-4 d-flex align-items-center gap-2">
                    ...
                    <h5 class="fw-bold mb-0 text-slate-800">Edit Course: {{ $course->course_code }}</h5>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.courses.update', $course->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="course_code" id="course_code" class="form-control @error('course_code') is-invalid @enderror" value="{{ old('course_code', $course->course_code) }}" required>
